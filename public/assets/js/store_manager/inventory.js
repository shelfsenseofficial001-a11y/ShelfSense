...
// Pricing and discounts live on the Catalog & Deals page instead -- this
// page is purely stock tracking, and never writes to a product's price,
// category, image, or discount.
// ============================================
        ...
        return `
            <div class="sm-product-card" data-id="${product.id}">
                ...
                <div class="sm-product-body">
                    ...
                    <div class="sm-product-price">${smCurrency(product.price)}</div>
