...
(function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // dispatches "sm-dashboard-rendered" and finishes *before* this
        ...
        if (document.getElementById('smDashCanvasStats')) {
            wireCanvasRows();
        } else {
            document.addEventListener('sm-dashboard-rendered', wireCanvasRows);
        }
    });
})();
