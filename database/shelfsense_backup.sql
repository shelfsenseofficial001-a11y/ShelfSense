...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 22, 2026 at 11:09 AM
...
(1, 'store', '2026-08', 100000.00, 0.00, NULL, '2026-08-21 16:47:43', '2026-08-21 16:47:43'),
...
(5, 'store', '', 0.00, 0.00, NULL, '2026-08-21 20:12:24', '2026-08-21 20:12:24');
...
(1, 5, 'invoice_received', 'Supplier has sent invoice for requisition #REQ-2026-0001. Please review and send to Finance.', '?page=store_manager_requisitions', 0, '2026-08-21 13:09:59'),
(2, 5, 'invoice_received', 'Supplier has sent invoice for requisition #REQ-2026-0002. Please review and forward to Finance Staff.', '?page=store_manager_requisitions', 0, '2026-08-21 20:10:28'),
(3, 5, 'invoice_forwarded', 'Invoice for requisition #REQ-2026-0002 has been forwarded to Finance Staff.', '?page=store_manager_requisitions', 0, '2026-08-21 20:11:02'),
(4, 5, 'invoice_received', 'Supplier has sent invoice for requisition #REQ-2026-0003. Please review and forward to Finance Staff.', '?page=store_manager_requisitions', 0, '2026-08-21 20:15:28'),
(5, 7, 'invoice_forwarded', 'Invoice for requisition #REQ-2026-0003 has been forwarded. Supplier: Sample Supplier Inc.', '?page=finance_staff_requisitions', 0, '2026-08-21 20:15:50'),
(6, 8, 'invoice_forwarded', 'Invoice for requisition #REQ-2026-0003 has been forwarded. Supplier: Sample Supplier Inc.', '?page=finance_staff_requisitions', 0, '2026-08-21 20:15:50'),
(7, 5, 'invoice_forwarded_success', 'Invoice for requisition #REQ-2026-0003 has been forwarded to Finance Staff.', '?page=store_manager_requisitions', 0, '2026-08-21 20:15:50'),
(8, 6, 'payment_request_pending', 'Payment request for requisition #REQ-2026-0002 is pending approval. Amount: ₱239.00', '?page=finance_head_payment_requests', 0, '2026-08-22 08:59:49');
...
INSERT INTO `payment_requests` (`id`, `requisition_id`, `supplier_invoice_id`, `requested_by`, `requested_at`, `status`, `approved_by`, `approved_at`, `rejection_reason`, `budget_checked`, `budget_exceeded`, `budget_exceeded_reason`, `notes`, `created_at`, `updated_at`) VALUES
(1, 2, 2, 7, '2026-08-22 08:59:48', 'pending', NULL, NULL, NULL, 1, 1, 'The requisition total (₱239.00) exceeds the remaining budget (₱0.00).', '', '2026-08-22 08:59:48', '2026-08-22 08:59:48');
...
(1, '978-0-123-45678-9', 'Sample Book', 'A sample book for testing', 1, 12.99, 8.00, 10, 5, NULL, 1, '2026-08-20 17:09:05', '2026-08-20 17:09:05'),
(2, 'BS-001', 'Sample Pen', 'A sample pen for testing', 2, 2.99, 1.20, 20, 5, NULL, 1, '2026-08-20 17:09:05', '2026-08-20 17:09:05');
...
(1, 'REQ-2026-0001', 5, 1, 'store', 'awaiting_finance', '2026-08-21', '2026-08', '2026-08-22', 127.80, 0.00, 127.80, '', '2026-08-21 12:55:51', '2026-08-21 16:47:42'),
(2, 'REQ-2026-0002', 5, 1, 'store', 'awaiting_finance', '2026-08-22', '', '2026-09-01', 239.00, 0.00, 239.00, 'test', '2026-08-21 20:09:46', '2026-08-22 08:59:48'),
(3, 'REQ-2026-0003', 5, 1, 'store', '', '2026-08-22', '', '2026-09-02', 103.90, 0.00, 103.90, '', '2026-08-21 20:15:04', '2026-08-21 20:21:47');
...
(1, 1, 1, 5, 10, 10.39, 103.90, 0, NULL, '2026-08-21 12:55:51'),
(2, 1, 2, 6, 10, 2.39, 23.90, 0, NULL, '2026-08-21 12:55:51'),
(3, 2, 2, 6, 100, 2.39, 239.00, 0, NULL, '2026-08-21 20:09:46'),
(4, 3, 1, 5, 10, 10.39, 103.90, 0, NULL, '2026-08-21 20:15:04');
...
INSERT INTO `supplier_invoices` (`id`, `invoice_number`, `requisition_id`, `supplier_id`, `invoice_date`, `subtotal`, `tax`, `total`, `due_date`, `status`, `po_match`, `gr_match`, `notes`, `paid_by`, `paid_at`, `created_at`, `updated_at`) VALUES
(1, 'INV-2026-0001', 1, 1, '2026-08-21', 127.80, 0.00, 127.80, '2026-09-01', 'pending', 0, 0, '', NULL, NULL, '2026-08-21 13:09:59', '2026-08-21 13:09:59'),
(2, 'INV-2026-0002', 2, 1, '2026-08-21', 239.00, 0.00, 239.00, '2026-09-01', 'pending', 0, 0, '', NULL, NULL, '2026-08-21 20:10:27', '2026-08-21 20:10:27'),
(3, 'INV-2026-0003', 3, 1, '2026-08-21', 103.90, 0.00, 103.90, '2026-09-05', 'pending', 0, 0, '', NULL, NULL, '2026-08-21 20:15:28', '2026-08-21 20:15:28');
