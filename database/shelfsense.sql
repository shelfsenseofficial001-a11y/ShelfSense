-- ShelfSense SQL Dump
-- Regenerated from live schema on Aug 25, 2026 at 10:53 PM
-- Includes: budget_adjustments table, payment_requests.approval_notes,
-- active_requisition_lock / uniq_active_requisition, payments.uniq_invoice_payment
-- (previously tracked only in database/schema_updates.sql)
--
-- Two personal-looking seed emails were replaced with @shelfsense.com placeholders.
...
INSERT INTO `users` VALUES (1,'SA-001','Super','Admin',NULL,'admin@shelfsense.com','$2y$10$JNrnPP.TfsAws1o1AwAYJ.Gim25c6QgPhyQFcMJOJLHAtUE3NyHTu','owner',5,0,0,1,1,NULL,NULL,15.00,15.00,5.00,0.00,'2026-08-20 17:09:05','2026-08-20 17:09:05'),(2,'HH-001','Maria','Santos',NULL,'hr.head@shelfsense.com','$2y$10$JNrnPP.TfsAws1o1AwAYJ.Gim25c6QgPhyQFcMJOJLHAtUE3NyHTu','hr_head',4,1,1,1,1,NULL,NULL,15.00,15.00,5.00,0.00,'2026-08-20 17:09:05','2026-08-20 17:09:05'),(3,'HS-001','Juan','Dela Cruz',NULL,'hr.staff@shelfsense.com','$2y$10$JNrnPP.TfsAws1o1AwAYJ.Gim25c6QgPhyQFcMJOJLHAtUE3NyHTu','hr_staff',1,1,0,1,1,NULL,NULL,15.00,15.00,5.00,0.00,'2026-08-20 17:09:05','2026-08-20 17:09:05'),(4,'HS-002','Ana','Reyes',NULL,'hr.staff2@shelfsense.com','$2y$10$JNrnPP.TfsAws1o1AwAYJ.Gim25c6QgPhyQFcMJOJLHAtUE3NyHTu','hr_staff',1,1,0,1,1,NULL,NULL,15.00,15.00,5.00,0.00,'2026-08-20 17:09:05','2026-08-21 14:44:43'),(5,'SM-001','Store','Manager',NULL,'store.manager@shelfsense.com','$2y$10$JNrnPP.TfsAws1o1AwAYJ.Gim25c6QgPhyQFcMJOJLHAtUE3NyHTu','store_manager',4,0,1,1,1,NULL,NULL,15.00,15.00,5.00,0.00,'2026-08-20 17:09:05','2026-08-20 17:09:05'),(6,'FH-001','Finance','Head',NULL,'finance.head@shelfsense.com','$2y$10$JNrnPP.TfsAws1o1AwAYJ.Gim25c6QgPhyQFcMJOJLHAtUE3NyHTu','finance_head',4,0,1,1,1,NULL,NULL,15.00,15.00,5.00,0.00,'2026-08-20 17:09:05','2026-08-20 17:09:05'),(7,'FS-001','Finance','Staff',NULL,'finance.staff@shelfsense.com','$2y$10$JNrnPP.TfsAws1o1AwAYJ.Gim25c6QgPhyQFcMJOJLHAtUE3NyHTu','finance_staff',1,0,0,1,1,NULL,NULL,15.00,15.00,5.00,0.00,'2026-08-20 17:09:05','2026-08-20 17:09:05'),(8,'FS-002','Sarah','Williams',NULL,'finance.staff2@shelfsense.com','$2y$10$JNrnPP.TfsAws1o1AwAYJ.Gim25c6QgPhyQFcMJOJLHAtUE3NyHTu','finance_staff',1,0,0,1,1,NULL,NULL,15.00,15.00,5.00,0.00,'2026-08-20 17:09:05','2026-08-20 17:09:05'),(9,'CA-001','Cashier','Test',NULL,'employee@shelfsense.com','$2y$10$JNrnPP.TfsAws1o1AwAYJ.Gim25c6QgPhyQFcMJOJLHAtUE3NyHTu','employee',1,1,0,1,1,NULL,NULL,15.00,15.00,5.00,0.00,'2026-08-20 17:09:05','2026-08-21 01:51:10'),(10,'CA-002','John','Doe',NULL,'employee2@shelfsense.com','$2y$10$JNrnPP.TfsAws1o1AwAYJ.Gim25c6QgPhyQFcMJOJLHAtUE3NyHTu','employee',1,1,0,1,1,NULL,NULL,15.00,15.00,5.00,0.00,'2026-08-20 17:09:05','2026-08-21 14:43:48'),(11,'TR-001','Trainee','User',NULL,'trainee@shelfsense.com','$2y$10$JNrnPP.TfsAws1o1AwAYJ.Gim25c6QgPhyQFcMJOJLHAtUE3NyHTu','trainee',0,0,0,1,1,NULL,NULL,15.00,15.00,5.00,0.00,'2026-08-20 17:09:05','2026-08-20 17:09:05'),(12,'SUP-001','Sample','Supplier',NULL,'supplier@shelfsense.com','$2y$10$JNrnPP.TfsAws1o1AwAYJ.Gim25c6QgPhyQFcMJOJLHAtUE3NyHTu','supplier',1,0,0,1,1,NULL,NULL,15.00,15.00,5.00,0.00,'2026-08-21 03:04:09','2026-08-21 03:07:17');
