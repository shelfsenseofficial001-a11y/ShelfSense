<?php
// app/handlers/finance/head/requisitions/list_pending.php
...
try {
    ...
    $result = $reqModel->getAll($page, $limit, ['status' => 'pending_finance_head']);
    ...
    error_log('finance/head/requisitions/list_pending.php error: ' . $e->getMessage());
