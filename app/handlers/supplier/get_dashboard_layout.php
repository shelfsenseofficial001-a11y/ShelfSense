<?php
// app/handlers/supplier/get_dashboard_layout.php
// Returns the current user's saved widget order for the Supplier dashboard,
// or null if they have never customized it (caller falls back to the
...
$stmt->execute([Auth::userId(), 'supplier_dashboard']);
$row = $stmt->fetch();
